...
const rankIcon = (rankIcon, rankLevel, percentile, username) => {
  switch (rankIcon) {
    ...
    case "profile":
      ...
      return `
        <svg x="-38" y="-30" height="66" width="66" aria-hidden="true" viewBox="0 0 16 16" version="1.1" data-view-component="true" data-testid="profile-rank-icon">
          <defs>
            <rect id="rect" width="100%" height="100%" rx="15"/>
            <clipPath id="clip">
              <use href="#rect"/>
            </clipPath>
          </defs>
          <use href="#rect"/>
          <image href="data:image/jpeg;base64,${base64ImageFetcher.encode(avatarUrl, { string: true })}" width="100%" height="100%" clip-path="url(#clip)"/>
        </svg>
      `;
    case "percentile":
      return `
